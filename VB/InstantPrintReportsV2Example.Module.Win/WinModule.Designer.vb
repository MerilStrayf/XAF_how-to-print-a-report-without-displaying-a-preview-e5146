Namespace InstantPrintReportsV2Example.Module.Win
    Partial Public Class InstantPrintReportsV2ExampleWindowsFormsModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' InstantPrintReportsV2ExampleWindowsFormsModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(InstantPrintReportsV2Example.Module.InstantPrintReportsV2ExampleModule))
