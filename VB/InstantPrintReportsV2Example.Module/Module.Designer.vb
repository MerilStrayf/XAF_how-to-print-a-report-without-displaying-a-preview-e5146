Namespace InstantPrintReportsV2Example.Module
    Partial Public Class InstantPrintReportsV2ExampleModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' InstantPrintReportsV2ExampleModule
            ' 
            Me.AdditionalExportedTypes.Add(GetType(DevExpress.Persistent.BaseImpl.ReportDataV2))
